...
# ============ YOUR API KEYS ============
ABUSEIPDB_API_KEY = ""  # Add AbuseIPDB key when you get it
...
class ThreatIntelligence:
    ...
    def check_url_threat(self, url: str) -> dict:
        ...
        suspicious_patterns = [
            ...
            r"paypal.*verify", r"amazon.*account",
        ]
        ...
        malicious_domains = [
            "malware.com", "phishing-site.xyz", "evil-domain.top",
            "testvirus.org", "badsite.tk", "wicar.org"
        ]
    ...
    def get_threat_summary(self) -> dict:
        """Get threat intel configuration status"""
        return {
            "apis_configured": bool(self.abuseipdb_key or self.virustotal_key or self.google_sb_key),
